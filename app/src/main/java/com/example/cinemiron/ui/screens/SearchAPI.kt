...
import com.example.cinemiron.tmp_ui.search.SearchState
import com.example.cinemiron.tmp_ui.search.SearchViewModel
...
@Composable
fun SearchScreenAPI(navController: NavController, modifier: Modifier = Modifier) {
