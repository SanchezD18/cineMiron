package com.example.cinemiron.tmp_movie.data.mapper_impl
...
import com.example.cinemiron.tmp_utils.GenreConstants
    ...
    override fun mapToDomain(apiDto: MovieDto): List<Movie> {
        return apiDto.results?.map { result ->
            Movie(
                ...
                id = result?.id ?: 0,
                originalLanguage = formatEmptyValue(result?.originalLanguage, "language_original"),
                originalTitle = formatEmptyValue(result?.originalTitle ,"title_original"),
